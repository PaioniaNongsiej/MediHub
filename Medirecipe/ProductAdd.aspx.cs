            ...
            {
                {
                    ...
                    SqlCommand cmd = new SqlCommand("insert into product " + " (category_id,product_name,short_des,long_des ,actual_price,selling_price,first_img) " +
                     "values('" + category_ID.Text + "','" + product_name.Text + "','" + s_des.Text + "','" + long_des.Text + "','" + actual_price.Text + "','" + sell_price.Text + "','" + filepath + "')", con);
                    cmd.ExecuteNonQuery();
                    con.Close();
