<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="category_add.aspx.cs" Inherits="Medirecipe.category_add" %>
...
<body>
    ...
    <div class="w3-main" style="margin-left:350px;margin-right:100px;text-align: center">
       ...
       <div class="form">
           ...
           <asp:TextBox ID="category_name" runat="server" placeholder="category name"  class="w3-border w3-padding" ></asp:TextBox>   
            <br />
