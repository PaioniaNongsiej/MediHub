<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecipeAlter.aspx.cs" Inherits="Medirecipe.RecipeAlter" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>MediRecipe | Alter Recipe</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- END ROW -->
                         ...
                         <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Alter Recipe</h4>
                                        <p class="card-title">&nbsp;</p>
                                        <p class="card-title-desc">
                                            ID  <asp:TextBox ID="recipe_id" runat="server" ReadOnly="true" Height="21px" Width="34px"/>    
                                               </p>
                                            <div>
                                                <table>    
                                         ...
                                         <div class="mb-3">
                                             ...
                                             <asp:TextBox id="ingredient" runat="server" class="form-control"  placeholder="ingredient" TextMode="MultiLine"></asp:TextBox>
                                            </div>
